...
public class MessageConstant {
    ...
    public static final String EDIT_ORDERSETTING_FAIL = "编辑预约人数失败";
    public static final String EDIT_ORDERSETTING_SUCCESS = "编辑预约人数成功";
    ...
    public static final String ADD_ORDERSETTING_SUCCESS = "新增预约成功";
    ...
    public static final String SEND_SMS_SUCCESS = "发送验证码成功，请留意短信，验证码10分钟内有效";
